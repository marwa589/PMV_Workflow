...
export default async function AdminApprovedDocumentsPage() {
  ...
  return (
    <DashboardShell role={session.role} userName={session.name} title="Approved Documents" subtitle="Administrative approved queue">
      <PageSummaryCards
        cards={[
          { label: "Approved", value: String(documents.length), tone: "bg-emerald-50 text-emerald-900 ring-1 ring-emerald-200" },
      ...
      <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <DocumentListTable documents={documents} emptyMessage="No approved documents." showDeleteAction />
      </section>
    </DashboardShell>
  );
}
