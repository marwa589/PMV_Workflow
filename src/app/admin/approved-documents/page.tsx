...
export default async function AdminApprovedDocumentsPage({ searchParams }: any) {
  ...
  return (
    <DashboardShell role={session.role} userName={session.name} title="Approved Documents" subtitle="Administrative approved queue">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <DocumentListTable documents={documents} emptyMessage="No approved documents." showBulkActions allowAdminDelete />
      </section>
    </DashboardShell>
  );
}
