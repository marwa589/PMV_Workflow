...
export default async function AdminRejectedDocumentsPage({ searchParams }: any) {
  ...
  return (
    <DashboardShell role={session.role} userName={session.name} title="Rejected Documents" subtitle="Administrative rejected queue">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <DocumentListTable documents={documents} emptyMessage="No rejected documents." showBulkActions allowAdminDelete />
      </section>
    </DashboardShell>
  );
}
