...
type ErrRow = { id: string; documentNumber: string; title: string; type: string; status: string; currentApproverId: string | null; currentApprover: { name: string } | null; createdAt: string; files: Array<{ originalName: string }> };

export default function ErrListTable({ errs, userId, canDelete, canRequestDeletion, showQuotation }: { errs: ErrRow[]; userId: string; canDelete: boolean; canRequestDeletion: boolean; showQuotation: boolean }) {
